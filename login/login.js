...
* @Last Modified time: 2017-09-18 21:28:42
*/
...
$(function(){
    ...
    //加载html
    $("#top").load("http://10.9.171.178/work/jfs/top.html",function(){
    ...
    $("#footer").load("http://10.9.171.178/work/jfs/footer.html",function(){
